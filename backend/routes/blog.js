...
//controllers
const { readBlog, createBlog, updateBlog, removeBlog, listBlogCount, listAllBlogs, listBlogByAuthor } = require('../controllers/blog')

router.get('/blogs/all', listAllBlogs)
router.get('/blogs/count', listBlogCount);
router.get('/blog/:slug', readBlog);
router.get('/blog', authCheck, listBlogByAuthor)
